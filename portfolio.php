...
<body>
    ...
    style="background-image:url(img/portfoliobgimg.jpg)">
            ...
            <div class="row">
                ...
                <div class="construct-contant1">
                 ...
                 <div class="crums d-flex text-white justify-content-center mt-3 fs-5">
                     <a href="index.html" class="mx-1 text-white">Home</a>| Portfolio
                </div> 
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="ion-ios-arrow-forward"></i> <a href="/pricing.html">Carrer</a></li>
                        </ul>
                    </div>
